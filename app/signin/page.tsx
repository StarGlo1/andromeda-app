      ...
      <div className="max-w-md w-full bg-[#c9bfb2]/60 dark:bg-gray-900/60 border border-default/20 rounded-xl p-8 shadow-lg relative z-10 mt-0">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            disabled={loading !== ""}
            className="w-full bg-gray-900 dark:bg-gray-800 border border-default text-white font-medium py-2.5 rounded-full transition-colors hover:bg-gray-800 dark:hover:bg-gray-700 disabled:opacity-50 flex items-center justify-center gap-2"
          >
